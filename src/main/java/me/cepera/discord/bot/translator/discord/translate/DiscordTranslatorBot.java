...
import me.cepera.discord.bot.translator.discord.DiscordPermissionsCalculator;
...
public class DiscordTranslatorBot extends EventDrivenDiscordBot implements DiscordPermissionsCalculator{
    ...
    void setup(TranslateService translateService,
        ...
        HideTranslationButtonInteractionHandler hideTranslationButtonInteractionHandler = new HideTranslationButtonInteractionHandler();
        ...
        addEventHandler(hideTranslationButtonInteractionHandler);
    }
    ...
    public Flux<ApplicationCommandRequest> commandsToRegister() {
        return Flux.create(sink->{
            ...
            sink.next(ApplicationCommandRequest.builder()
                    ...
                    .defaultMemberPermissions(permissionBits(Permission.ADMINISTRATOR))
                    .dmPermission(false)
                    .build());
